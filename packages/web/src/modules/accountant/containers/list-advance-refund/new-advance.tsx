...
const itemNewAdvance = [
  {
    ...
    beneficiaryAccount: {
      ...
      bank: 'MSB - Ngân hàng TMCP Ngoại Thương Việt Nam',
      accountImage: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8VNiaQ668iSH2hlM0vV2UBmUQYFOWjlLvYg&s'
    },
...
export const NewAdvance = observer(() => {
