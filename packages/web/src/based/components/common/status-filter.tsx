...
export const StatusFilter = observer(() => {
  ...
  return (
    <div className='flex gap-2 p-2 items-center text-xs'>
      ...
      <div
        className={`cursor-pointer py-1 px-2 rounded-3xl ${filter.status === 'active' ? 'bg-[#EEF3FE] text-blue-600' : 'bg-gray-200'
          }`}
      ...
      <div
        className={`cursor-pointer py-1 px-2 rounded-3xl ${filter.status === 'inactive' ? 'bg-[#EEF3FE] text-blue-600' : 'bg-gray-200'
          }`}
